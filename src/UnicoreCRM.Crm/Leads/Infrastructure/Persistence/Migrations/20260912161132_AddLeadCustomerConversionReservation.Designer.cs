...
namespace UnicoreCRM.Crm.Leads.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260912161132_AddLeadCustomerConversionReservation")]
    partial class AddLeadCustomerConversionReservation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UnicoreCRM.Crm.Leads.Domain.Lead", b =>
                {
                    ...
                    b.Property<string>("PendingCustomerConversionId")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
                    ...
                    b.HasIndex("WorkspaceId", "ArchivedAt", "UpdatedAt", "LeadId");

                    b.HasIndex("WorkspaceId", "ScopeOwnerId", "ArchivedAt", "UpdatedAt", "LeadId");
