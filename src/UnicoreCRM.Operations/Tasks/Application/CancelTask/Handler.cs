...
namespace UnicoreCRM.Operations.Tasks.Application.CancelTask;

internal sealed record Command(string TaskId, CancelTaskRequest Request, TaskCommandMetadata Metadata);
