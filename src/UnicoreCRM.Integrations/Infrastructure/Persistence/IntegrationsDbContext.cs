...
internal sealed class IntegrationsDbContext(DbContextOptions<IntegrationsDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OutboundWebhookDelivery>().Property(x => x.RetryCycleAttemptCount);
        modelBuilder.Entity<OutboundWebhookDelivery>().Property(x => x.RowVersion).IsRowVersion();
    }
}
